  ...
  return (
    <div
      className={`relative h-full overflow-hidden rounded-3xl 
        bg-white/80 dark:bg-slate-800 p-px 
        ...
        after:z-30 after:h-96 after:w-96 
        after:translate-x-[var(--mouse-x)] after:translate-y-[var(--mouse-y)] 
        after:rounded-full 
        after:bg-slate-400 dark:after:bg-indigo-500 
        after:opacity-0 after:blur-[100px] 
        after:transition-opacity after:duration-500 
        after:group-hover:opacity-10
        before:group-hover:opacity-100
        shadow-sm dark:shadow-none
        ring-1 ring-slate-200/50 dark:ring-slate-800
        ${className}`}
    >
      {children}
    </div>
